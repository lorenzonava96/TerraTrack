...
🛰️ **TerraTrack** is an open-source, cloud-based workflow for detecting and monitoring slow-moving landslides using Sentinel-2 imagery and optical feature tracking. For further details, please consult the paper "A Workflow to Identify and Monitor Slow-Moving Landslides through Spaceborne Optical Feature Tracking" by [Nava et al (2025)](https://doi.org/10.5194/egusphere-2025-2795).
