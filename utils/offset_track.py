...
def block_matching_vectorized(img1, img2, block_size=16, overlap=0.8, match_func='phase_cross_corr', subpixel_method="center_of_mass"):
    """
    ...
    def fft_ncc(block1, block2, subpixel_method="center_of_mass"):
        ...
        - subpixel_method: Method for subpixel refinement. Options:
            "center_of_mass" - Uses center of mass around peak.
            "quadratic" - Quadratic peak fitting.
    ...
    def quadratic_interpolation(values, peak_index):
        """
        Perform quadratic interpolation around the peak.

        Parameters:
        - values: 1D array of correlation values along a row or column.
        - peak_index: Index of the maximum value.

        Returns:
        - Refined subpixel position.
        """
    ...
    def parabolic_interpolation(values, peak_index):
        """
        Perform parabolic interpolation for subpixel refinement.
...
def process_image_pairs(dat1, dat2, datax, preprocessed_stack, filter_params, zero_mask=None,
                        method='block_matching', block_size=32, overlap=0.8, match_func='phase_cross_corr', subpixel_method='center_of_mass', max_workers=None):
    """
